...
import com.SGY.c_utils.content.SGYStringUtils;
import com.SGY.c_utils.device.NetSpeedUtils;
import com.SGY.c_utils.device.SGYSDCardUtils;
import com.SGY.c_utils.file.SGYSizeConverter;
import com.SGY.c_utils.security.SGYApkSignUtils;
import com.SGY.c_utils.security.SGYAppSignUtils;
import com.SGY.c_utils.security.SGYRsaUtils;
import com.SGY.c_utils.time.SGYTimeUtils;
...
//        aaa();
        String aa = SGYStringUtils.substring("的士大夫aa", 5);
    ...
    public void aaa() {
        ...
        // 解密文本
        String decryptText = SGYRsaUtils.decryptByPublicKey(encryptText, PUBLIC_KEY);
        // 验证签名
        boolean result = SGYRsaUtils.verifyByPublicKey(decryptText, PUBLIC_KEY, sign);
        if (result) {
        ...
        String enStr = SGYRsaUtils.encryptByPrivateKey("士大夫夫士大夫撒旦范德萨夫士大夫第三方第三方士大夫第三方士大夫地方收到发顺丰士大夫都是反低俗发生的夫士大夫第三方收到夫士大夫士大夫是否收到夫士大夫收到房贷首付士大夫发发顺丰士大夫是大师傅士大夫大师傅士大夫大师傅士大夫士大夫是", PRIVATE_KEY);
        String denStr = SGYRsaUtils.decryptByPublicKey(enStr, "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAMpz+9+JhsA+bbmeTTWdy0VD4kidY+ePKzCeDwT7uM4/Otn3sshJTHLusNHzjm5ZQJsX4V/JK1Wo1Y+wmmMzpWECAwEAAQ==");
    ...
    private void netSpeed() {
        ...
        netSpeedUtils.setOnNetSpeedListener(new NetSpeedUtils.OnNetSpeedListener() {
            ...
            public void netSpeed(int netSpeed) {
                 ...
                 */
                String kb = SGYSizeConverter.KBTrim.convert(netSpeed / 1024);
    ...
    private void signInfoDemo() {
        List<String> list = SGYApkSignUtils.getSingInfo(SGYSDCardUtils.getExternalStorageDirectory() + "/CCTV5_CCTV_2019-01-23.apk", SGYApkSignUtils.SHA256);
        for (String s : list) {
            System.out.println("1-=" + s);
        }
        System.out.println("2=" + SGYApkSignUtils.sha1(SGYSDCardUtils.getExternalStorageDirectory() + "/CCTV5_CCTV_2019-01-23.apk"));

        System.out.println("====================================================");

        System.out.println("3=" + SGYAppSignUtils.md5());
        List<String> list2 = SGYAppSignUtils.getSingInfo(SGYAppSignUtils.SHA1);
        for (String s : list2) {
    ...
    private void timeDemo() {
        System.out.println(SGYTimeUtils.getMillis("2019-04-02 13:09:09"));
        System.out.println(SGYTimeUtils.format(System.currentTimeMillis() + 6 * 60 * 60 * 1000, SGYTimeUtils.FORMATE_FULL.concat(" a")));
        System.out.println(SGYTimeUtils.format("2019-04-02 13:09:09", "HH小时mm分钟ss秒"));
        Period period = SGYTimeUtils.period(System.currentTimeMillis() - 62 * 60 * 1000, System.currentTimeMillis());
        ...
        System.out.println("===================================================");
        Period perio2 = SGYTimeUtils.period("2018-04-02 13:09:09", "2019-04-02 14:10:10");
        ...
        System.out.println("===================================================");
        Duration duration = SGYTimeUtils.duration("2018-04-02 13:09:09", "2019-04-02 14:10:10");
        ...
        System.out.println("===================================================");
        Interval interval = SGYTimeUtils.interval("2018-04-02 13:09:09", "2019-04-02 14:10:10");
        ...
        System.out.println("指定时间是否在指定的时间段内：" + interval.contains(SGYTimeUtils.getMillis("2019-04-03 15:10:10")));
        System.out.println("===================================================");
        Interval interval2 = SGYTimeUtils.interval(System.currentTimeMillis() - 62 * 60 * 1000, System.currentTimeMillis() + 62 * 60 * 1000);
        ...
        System.out.println("指定时间是否在指定的时间段内：" + interval2.contains(SGYTimeUtils.getMillis("2019-04-03 15:10:10")));
        System.out.println("===================================================");
        System.out.println(SGYTimeUtils.duration(62 * 1000, true));
