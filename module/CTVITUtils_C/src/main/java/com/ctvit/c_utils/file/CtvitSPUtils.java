...
public final class CtvitSPUtils {
    /**
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = CtvitSPUtils.class.getName().replace(".", "_").toUpperCase(Locale.CHINA);
    ...
    public static void put(String fileName, String key, Object object, boolean apply) {
        SharedPreferences sp = CtvitUtils.getContext().getSharedPreferences(fileName, Context.MODE_PRIVATE);
