...
public class CtvitResUtils {
    ...
    public static String getString(@StringRes int resId, Object... formatArgs) {
        return CtvitUtils.getContext().getString(resId, formatArgs);
    }
    ...
    public static int getColor(@ColorRes int resId) {
        return CtvitUtils.getContext().getResources().getColor(resId);
    }
    ...
    public static int getDimensionPixelSize(@DimenRes int resId) {
        return CtvitUtils.getContext().getResources().getDimensionPixelSize(resId);
    }
    ...
    public static int getDimensionPixelOffset(@DimenRes int resId) {
        return CtvitUtils.getContext().getResources().getDimensionPixelOffset(resId);
    }
    ...
    public static float getDimension(@DimenRes int resId) {
        return CtvitUtils.getContext().getResources().getDimension(resId);
    }
    ...
    public static Drawable getDrawable(@DrawableRes int resId, @Nullable Resources.Theme theme) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return CtvitUtils.getContext().getResources().getDrawable(resId, theme);
        } else
            return CtvitUtils.getContext().getResources().getDrawable(resId);
    }
    ...
    public static Drawable getDrawable(@DrawableRes int resId) {
        return CtvitResUtils.getDrawable(resId, null);
    }
}
