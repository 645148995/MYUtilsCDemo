...
public class SGYScaleUtils {
    ...
    public static int countScale(int scaleW, int scaleH) {
        int sw = SGYScreenUtils.getWidth();
        float scale = 1;
        try {
    ...
    public static int countScaleOfWid(int wDp, int scaleW,
                                      int scaleH) {
        int wPx = DensityUtils.dpToPx(wDp);
    ...
    public static int[] countScale(int scaleW, int scaleH,
        ...
        int marginPx = DensityUtils.dpToPx(marginDp);
        double widthPx = (SGYScreenUtils.getWidth() - marginPx) / column;
        float scale = Float.valueOf(percnet(Double.valueOf(scaleW + ""),
                Double.valueOf(scaleH + "")));
    ...
    public static int countScale(int scaleW, int scaleH, int marginPx) {
        int sw = SGYScreenUtils.getWidth() - marginPx;
        float scale = 1;
        try {
    ...
    public static int[] countScale2(int scaleW, int scaleH,
        ...
        int marginPx = DensityUtils.dpToPx(marginDp);
        int widthPx = (SGYScreenUtils.getWidth() - marginPx) / column;
        float W = widthPx
                - widthPx
