 ...
 * @description 状态栏样式
 **/
public class SGYStatusBarUtils {
    ...
    public SGYStatusBarUtils(Activity activity) {
        mActivity = activity;
    }

    public static SGYStatusBarUtils with(Activity activity) {
        return new SGYStatusBarUtils(activity);
    }
    ...
    public SGYStatusBarUtils setColor(int color) {
        mColor = color;
        return this;
    }
    ...
    public SGYStatusBarUtils setDrawable(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public SGYStatusBarUtils setIsActionBar(boolean actionBar) {
     ...
     * @return
     */
    public SGYStatusBarUtils setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
     ...
     * 去除 ActionBar 阴影
     */
    public SGYStatusBarUtils clearActionBarShadow() {
